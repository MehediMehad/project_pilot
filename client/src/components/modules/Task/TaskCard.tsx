...
export default function TaskCard({
  ...
  return (
    <div
      className={`bg-card text-card-foreground border border-t-4 rounded-xl shadow-xs transition-all duration-300 hover:shadow-md flex flex-col justify-between ${statusColors[status]}`}
    >
